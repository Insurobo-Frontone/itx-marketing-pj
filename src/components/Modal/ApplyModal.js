  ...
  return (
      <Modal apply onClick={onClick}>
        ...
        {modalData.map((md) => (
            ...
            <ModalContent key={md.id}>
            <ModalTitle>{md.title}</ModalTitle>
            <TextWrapper>
              ...
              <ul>
                ...
                <li>{` - 필수항목 : ${md.article}`}</li>
                <li> 2) 수집 및 이용목적</li>
                <li>{`- 회사가 제공하는 ${md.title} 신청에 대한 응대`}</li>
                <li>3) 개인정보 보유기간</li>
                <li>- 동의한 날로부터 1년 이내 또는 동의를 철회하는 때까지</li>
                <li>4) 동의를 거부할 권리 및 그에 따른 불이익</li>
                <li>-귀하는 개인정보의 수집 및 이용에 관하여 동의를 거부할 권리가 있습니다.</li>
                <li>{`다만, 위 동의절차는 필수적인 항목으로 부동의 하는 경우 ${md.title} 진행이 불가능할 수 있음을 알려드립니다. 본 동의를 하시더라도, 당사 고객센터를 통해 동의를 철회하실 수 있습니다.\n (고객센터: 01-6952-2957)`}</li>
                <li>회사는 원칙적으로 귀하의 개인정보를 동의 없이 타 기업 또는 기관에 제공하지 않습니다. 다만 관계 법령의 규정에 의하거나 수사기관의 요구가 있을 경우 예외적으로 동의 없이 귀하의 개인정보를 제공할 수 있습니다.</li>
              </ul>
            </TextWrapper>
            </ModalContent>
